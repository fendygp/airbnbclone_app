...
export const rooms = [
  {
    id: 1,
    title:
      "[New Open] Marita m01, right in front of the beach, couple pension, quiet village, Gwakji, near Hyeopjae",
    ...
    is_wishlist: false,
    coordinate: {latitude: -8.650000, longitude: 115.216666},
    characteristics: true,
    tag: true,
  },
  {
    id: 2,
    title: "Bali Gaming Denpasar Mini-Mary [Mini-Mary Room:]",
    property_type: "whole house",
    max_capacity: 4,
    bedrooms: 1,
    beds: 3,
    ...
    is_wishlist: true,
    coordinate: {latitude: -8.650000, longitude: 115.216669},
    characteristics: true,
    tag: false,
  },
  {
    id: 3,
    title: "[Hi-Residence] New Studio near Denpasar Central Airport (Standard)",
    property_type: "whole house",
    max_capacity: 3,
    bedrooms: 1,
    beds: 2,
    ...
    is_wishlist: false,
    coordinate: {latitude: -8.650000, longitude: 115.216667},
  ...
  {
    id: 4,
    title: "House in the middle of a tangerine field, Tangerine Denpasar #202",
    property_type: "whole house",
    max_capacity: 2,
    bedrooms: 1,
    beds: 2,
  ...
  {
    id: 5,
    title: "Ju's home(2) 9km from the airport/ Denpasar accommodation on the 2nd floor in front of the beach in Denpasar City",
    property_type: "whole house",
    max_capacity: 4,
    bedrooms: 1,
    beds: 4,
